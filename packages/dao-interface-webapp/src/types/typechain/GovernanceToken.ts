...
export interface GovernanceTokenInterface extends utils.Interface {
  functions: {
    ...
    "PRICE_PER_VOTE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "PRICE_PER_VOTE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GovernanceToken extends BaseContract {
  ...
  functions: {
    ...
    PRICE_PER_VOTE(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    PRICE_PER_VOTE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
