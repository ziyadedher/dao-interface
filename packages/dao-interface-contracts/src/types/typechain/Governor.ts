...
export interface GovernorInterface extends utils.Interface {
  functions: {
    ...
    "veto(uint256,uint256)": FunctionFragment;
    "vetoToken()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "vetoToken", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "vetoToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "votingDelay",
    data: BytesLike
  ): Result;
...
export interface Governor extends BaseContract {
  ...
  functions: {
    ...
    vetoToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    vetoToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    vetoToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
